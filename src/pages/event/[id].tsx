          ...
          <div className='my-12'>
            ...
            <div className="mt-6 flex justify-between ">
              <p className="flex items-center text-gray-500">
                <svg style={{ color: 'white', marginRight: 10 }} xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-calendar-day" viewBox="0 0 16 16">
              ...
              <p className="flex items-center text-gray-500">
                <svg style={{ color: 'white', marginRight: 10 }} xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-clock-fill" viewBox="0 0 16 16">
              ...
              <p className="flex items-center text-gray-500">
                <svg style={{ color: 'white', marginRight: 10 }} width="25" height="25" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
